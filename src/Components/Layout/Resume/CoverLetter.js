        ...
        <Grid item xs={12} >
          ...
          <List className={body}>
            ...
            <ListItem>
              ...
              <Typography variant="body1">
                I am a very organized person with excellent communication skills. Proven ability to take instructions and to communicate effectively to conduct needs analyses and develop resolutions and options;
              </Typography>
            </ListItem>
            <ListItem>
              <ListItemIcon>  
              ...
              <Typography variant="body1">
                I also have many years of experience working in team environments due to my military and construction background;
              </Typography>
            </ListItem>
          </List>
          <Typography variant="body1" className={body}>
