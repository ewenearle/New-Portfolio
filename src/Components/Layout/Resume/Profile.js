    ...
    <div>
      <Grid container spacing={24}>
        ...
        <Grid item xs>
          ...
          <Typography className={classes.profileTitle} variant="h6" gutterBottom>
              PROFILE
          </Typography>
          Passionate and engaged Junior Web Developer. Tenacious, creative, and self-disciplined offering 13+ years of experience in IT, construction, and military environments. Passionate about learning new technologies, bringing ideas to life, and working with dedicated teams to build efficient and robust applications suited to the user's needs.
            </Grid>
        </Grid>
